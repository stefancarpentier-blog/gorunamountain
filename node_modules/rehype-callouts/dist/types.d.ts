 ...
 */
export type CreateProperties = (node: BlockquoteElement, type: string) => Properties | null;
...
export type RequiredOptions = Required<Options<CalloutConfig, Required<TagsConfig>, Required<PropsConfig>>>;
export {};
